...
var efficiency = document.getElementById("rating-efficiency");
...
function getChartJs(type) {
    ...
    if (type === 'line') {
        ...
        config = {
            type: 'bar',
            data: {
                labels: ["Efficiency", "Timeliness", "Quality", "Accuracy"],
                datasets: [{
                    label: "",
                    data: [efficiency.value, timeliness.value, quality.value, accuracy.value, 0, 5],
